...
public class DtrConfig {
	...
	public static DtrConfig Load() 
		=> Service.PluginInterface.LoadCharacterFile<DtrConfig>(Service.PlayerState.ContentId, "DTR.config.json");

	public void Save()
		=> Service.PluginInterface.SaveCharacterFile(Service.PlayerState.ContentId, "DTR.config.json", this);
