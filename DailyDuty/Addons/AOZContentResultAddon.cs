...
public unsafe class AOZContentResultAddon : IDisposable
{
    ...
    private delegate nint AddonOnSetup(AtkUnitBase* addon, long valueCount, AtkValue* values);
    ...
    private nint OnSetup(AtkUnitBase* addon, long valueCount, AtkValue* values)
    {
