...
public interface IFashionReportClickableLink
{
...
public interface IFashionReportModuleConfig
{
    [EnumConfig("CompletionMode")]
    public FashionReportMode CompletionMode { get; set; }
}

public class FashionReportConfig : IModuleConfigBase, IFashionReportClickableLink, IFashionReportModuleConfig
{
    // IModuleEnable
    ...
    public FashionReportMode CompletionMode { get; set; } = FashionReportMode.Single;
