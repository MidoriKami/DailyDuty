...
public interface IDomanEnclaveClickableLinkConfiguration
{
    [BoolDescriptionConfig("Enable", "DomanEnclaveTeleport")] 
    public bool ClickableLink { get; set; }
}

public class DomanEnclaveConfig : IModuleConfigBase, IDomanEnclaveClickableLinkConfiguration
{
    // IModuleEnable
