...
public interface ILevequestModuleConfig
{
    [IntConfig("NotificationThreshold", 0, 100)]
...
public class LevequestConfig : IModuleConfigBase, ILevequestModuleConfig
{
    // IModuleEnable
    ...
    public int NotificationThreshold { get; set; } = 95;
    public ComparisonMode ComparisonMode { get; set; } = ComparisonMode.EqualTo;
}