    ...
    internal class CustomDelivery : IConfigurable
    {
        ...
        private readonly InfoBox notificationOptions = new()
        {
            ...
            ContentsAction = () =>
            {
                ...
                {
                    Service.LogManager.LogMessage(ModuleType.CustomDelivery, "Login Notifications " + (Settings.Enabled ? "Enabled" : "Disabled"));
                    Service.CharacterConfiguration.Save();
                }
                ...
                {
                    Service.LogManager.LogMessage(ModuleType.CustomDelivery, "Zone Change Notifications " + (Settings.Enabled ? "Enabled" : "Disabled"));
                    Service.CharacterConfiguration.Save();
                }
            }
        };
        ...
        {
            ImGui.TextColored(Settings.Enabled ? Colors.SoftGreen : Colors.SoftRed, Strings.Module.CustomDeliveryLabel);
