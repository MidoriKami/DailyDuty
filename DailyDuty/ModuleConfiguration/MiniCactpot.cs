    ...
    internal class MiniCactpot : IConfigurable
    {
        ...
        private readonly InfoBox notificationOptions = new()
        {
            ...
            ContentsAction = () =>
            {
                ...
                {
                    Service.LogManager.LogMessage(ModuleType.MiniCactpot, "Login Notifications " + (Settings.Enabled ? "Enabled" : "Disabled"));
                    Service.CharacterConfiguration.Save();
                }
                ...
                {
                    Service.LogManager.LogMessage(ModuleType.MiniCactpot, "Zone Change Notifications " + (Settings.Enabled ? "Enabled" : "Disabled"));
                    Service.CharacterConfiguration.Save();
                }
            }
        };
