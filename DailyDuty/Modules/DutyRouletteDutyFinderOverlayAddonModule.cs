...
{
    internal unsafe class DutyRouletteDutyFinderOverlayAddonModule : IAddonModule
    {
        ...
        public delegate void* AgentShow(void* a1);
        ...
        public delegate void AddonDraw(AtkUnitBase* atkUnitBase);
        public delegate byte AddonOnRefresh(AtkUnitBase* atkUnitBase, int a2, long a3);    
