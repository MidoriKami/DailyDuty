...
// 			switch (this) {
// 				case LuminaTaskDataList<ContentsNote>:
// 					ImGui.Text(Services.DataManager.GetExcelSheet<ContentsNote>().GetRow(dataEntry.RowId).Name.ToString());
// 					break;
//                 
// 				case LuminaTaskDataList<ContentRoulette>:
// 					ImGui.Text(Services.DataManager.GetExcelSheet<ContentRoulette>().GetRow(dataEntry.RowId).Name.ToString());
// 					break;
//                 
// 				case LuminaTaskDataList<ClassJob>:
// 					var classJob = Services.DataManager.GetExcelSheet<ClassJob>().GetRow(dataEntry.RowId);
// 					var classJobLabel = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(classJob.Name.ToString());
// 					ImGui.Text(classJobLabel);
// 					break;
//                 
// 				case LuminaTaskDataList<MobHuntOrderType>:
// 					var mobHuntOrderType = Services.DataManager.GetExcelSheet<MobHuntOrderType>().GetRow(dataEntry.RowId);
...
//                 
// 				case LuminaTaskDataList<Addon>:
// 					ImGui.Text(Services.DataManager.GetExcelSheet<Addon>().GetRow(dataEntry.RowId).Text.ToString());
// 					break;
// 			}
//             
// 			ImGui.TableNextColumn();
...
// 				ImGui.TableNextColumn();
// 				var luminaData = Services.DataManager.GetExcelSheet<ContentFinderCondition>().GetRow(data.RowId);
