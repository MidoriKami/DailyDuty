...
//             System.WindowManager.AddWindow(new ContentsNoteSelectionWindow(Services.PluginInterface) {
...
//         }
//         
//         var enabledWarnings = WarningEntries.Select(warning => Services.DataManager.GetExcelSheet<ContentsNote>().GetRow(warning)).ToList();
//         
...
//         base.Load();
//         
//         Services.AddonLifecycle.RegisterListener(AddonEvent.PostSetup, "ContentsFinder", OnContentsFinderOpen);
//     }
//
...
//             Services.Log.Info($"Suppressing Duty Finder Warning, time elapsed: {warningThrottleTimer.Elapsed} :: Unlocked at 5mins");
//             return;
//         }
//
...
//                 var taskInfo = Services.DataManager.GetExcelSheet<ContentsNote>().GetRow(warningId);
//                 
