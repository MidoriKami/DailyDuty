...
// 		var result = false;
// 		
// 		foreach (var category in Services.DataManager.GetExcelSheet<ContentsNoteCategory>().Where(category => category.Name.ToString() != string.Empty)) {
// 			if (ImGui.CollapsingHeader(category.Name.ToString())) {
// 				using var indent = ImRaii.PushIndent();
// 				
// 				foreach (var option in ConfigList) {
// 					var luminaData = Services.DataManager.GetExcelSheet<ContentsNote>().GetRow(option.RowId);
