...
namespace DailyDuty.Localization
{
    internal static class Strings
    {
        ...
        public class ModuleStrings
        {
            ...
            public readonly string WondrousTailsOpenBookClickableLinkDescription = Loc.Localize("WondrousTailsOpenBookClickableLinkDescription", "Notifications can be clicked on to open your Wondrous Tails book, new book available notifications can be clicked on to teleport to Idyllshire");
