...
namespace DailyDuty.Localization
{
    internal static class Strings
    {
        ...
        public class ModuleStrings
        {
            ...
            public readonly string WondrousTailsIdyllshireTeleportLinkDescription = Loc.Localize("WondrousTailsIdyllshireTeleportLinkDescription", "New book available notifications can be clicked on to teleport to Idyllshire");
